...
static constexpr auto s_tag = "[DataTimePlotsAnalyzer]";

TEST_CASE("Standard checks of DataTimePlotsAnalyzer", s_tag) {
  const std::string baseConfig{
      R"_(from FWCore.TestProcessor.TestProcess import *
process = TestProcess()
process.toTest = cms.EDProducer("DataTimePlotsAnalyzer"
